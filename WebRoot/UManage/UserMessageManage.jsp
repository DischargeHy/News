						...
						<form class="am-form am-form-horizontal" method="post" action="../UserMessageUpdateServlet">
							...
							<div class="am-form-group address">
								...
								<div class="am-form-content">
									...
									%>
									<input type="text" name="usertypeName" value="小编申请失败" readonly="readonly" style="width: 115px; float: left;"> <input id="submit" type="button" value="重新申请" class="am-btn am-btn-danger am-btn-xs" onclick="show_apply()" style="margin-left: 10px; margin-top: 4px;" />
									<%
										} else {
												}
											}
