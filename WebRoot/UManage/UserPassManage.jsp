		...
		<div class="col-main">
			...
			<div style="float: left;">
				<ul class="am-list am-list-border" style="width: 110px;">
					...
					<li><a href="../UManage/UserPassManage.jsp" style="font-size: 13px;"> <i class="am-icon-book am-icon-fw"></i> 密码管理
					</a></li>
				...
				<form class="am-form am-form-horizontal" method="post" action="../UserPassUpdateServlet">
					<div class="am-form-group">
						...
						<div class="am-form-content">
							<input type="password" id="user-old-password" placeholder="请输入原登录密码" name="txt_uRealPass" minlength="6" maxlength="16">
						</div>
					</div>
					<div class="am-form-group">
						<label for="user-new-password" class="am-form-label">新密码</label>
						<div class="am-form-content">
							<input type="password" id="user-new-password" placeholder="请输入新密码" name="txt_uPass" minlength="6" maxlength="16">
						</div>
					</div>
					<div class="am-form-group">
						<label for="user-confirm-password" class="am-form-label">确认密码</label>
						<div class="am-form-content">
							<input type="password" id="user-confirm-password" placeholder="请再次输入新密码" name="txt_ReuPass" minlength="6" maxlength="16">
						</div>
					</div>
					<div class="info-btn">
						<div>
