		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">新闻类型修改页面</h4></li>
				</ul>
			...
			<div class="content">
				<div class="am-g">
                    ...
                    <form action="#" class="am-form" data-am-validator>
                      <fieldset>
                        <legend>新闻类型修改</legend>
                        
                        <div class="am-form-group">
                          <label for="doc-vld-url-2">新闻类型修改：</label>
                          <input type="url" id="doc-vld-url-2" name="" placeholder="请输入类型" required/>
                        </div>
