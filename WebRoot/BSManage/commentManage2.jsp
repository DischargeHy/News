	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
							  ...
							  <span class="am-icon-table"></span> 新闻管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						    ...
						    <li class="admin-parent">
							  ...
							  <i class="am-icon-line-chart" aria-hidden="true"></i> 
							  评论管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
					...
					<!-- Row start -->
						<div class="am-u-sm-12">
                            ...
                            <table class="am-table">
                                <thead>
                                    <tr>
                                        <th width="550" style="word-break:break-all">评论详情</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="550" style="word-break:break-all">新闻标题：newstitle<br />评论用户：username<br />评论内容：talktitle</td>
                                        
                                        <td width="180" style="word-break:break-all">talktime</td>
										<td width="80" style="word-break:break-all"><div align="center" >
										<input type="checkbox" name="checkbox" value="checkbox"/></div></td>
                                        <td><a href=""><button type="submit">删除</button></a> &nbsp;
										<a 	href=""><button type="submit">取消举报</button></a></td>
                                    </tr>
                                     <tr>
                                        <td width="550" style="word-break:break-all">新闻标题：newstitle<br />评论用户：username<br />评论内容：talktitle</td>
                                        <td width="180" style="word-break:break-all">talktime</td>
                                    ...
                                    <tr>
                                         <td width="550" style="word-break:break-all">新闻标题：newstitle<br />评论用户：username<br />评论内容：talktitle</td>
                                        <td width="180" style="word-break:break-all">talktime</td>
										<td width="80" style="word-break:break-all"><div align="center"><input type="checkbox" name="checkbox" value="checkbox"  /></div></td>
                                        <td><a href=""><button type="submit">删除</button></a> &nbsp;
										<a 	href=""><button type="submit">取消举报</button></a></td>
                                    </tr>
                                </tbody>
